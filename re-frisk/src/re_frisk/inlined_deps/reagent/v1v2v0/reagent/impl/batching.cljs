(ns ^{:mranderson/inlined true} re-frisk.inlined-deps.reagent.v1v2v0.reagent.impl.batching
  (:refer-clojure :exclude [flush])
  (:require [re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug :refer-macros [assert-some]]
            [re-frisk.inlined-deps.reagent.v1v2v0.reagent.impl.util :refer [is-client]]))
