(ns re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug
...
(defmacro log
  ...
  [& forms]
  `(when re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug.has-console
...
(defmacro warn
  ...
  (when *assert*
    `(when re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug.has-console
       (.warn (if re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug.tracking
                re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug.track-console
                js/console)
              (str "Warning: " ~@forms)))))
...
(defmacro error
  ...
  (when *assert*
    `(when re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug.has-console
       (.error (if re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug.tracking
                 re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug.track-console
                 js/console)
               (str ~@forms)))))
