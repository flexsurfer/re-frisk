(ns ^{:mranderson/inlined true} re-frisk.inlined-deps.reagent.v1v2v0.reagent.ratom
  ...
  (:require-macros [re-frisk.inlined-deps.reagent.v1v2v0.reagent.ratom])
  (:require [re-frisk.inlined-deps.reagent.v1v2v0.reagent.impl.util :as util]
            [re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug :refer-macros [warn dev?]]
...
(defn- pr-atom [a writer opts s v]
  (-write writer (str "#object[re-frisk.inlined-deps.reagent.v1v2v0.reagent.ratom." s " "))
