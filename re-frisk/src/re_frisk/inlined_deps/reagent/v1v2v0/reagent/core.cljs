(ns ^{:mranderson/inlined true} re-frisk.inlined-deps.reagent.v1v2v0.reagent.core
  (:require-macros [re-frisk.inlined-deps.reagent.v1v2v0.reagent.core])
  (:refer-clojure :exclude [partial atom flush])
  (:require [react :as react]
            [re-frisk.inlined-deps.reagent.v1v2v0.reagent.impl.template :as tmpl]
            [re-frisk.inlined-deps.reagent.v1v2v0.reagent.impl.component :as comp]
            ...
            [re-frisk.inlined-deps.reagent.v1v2v0.reagent.debug :as deb :refer-macros [assert-some assert-component
...
(defn render
  ...
  [& _]
  (throw (js/Error. "Reagent.core/render function was moved to re-frisk.inlined-deps.reagent.v1v2v0.reagent.dom namespace in Reagent v1.0.")))
