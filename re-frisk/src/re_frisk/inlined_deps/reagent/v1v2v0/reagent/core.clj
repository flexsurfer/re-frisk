(ns ^{:mranderson/inlined true} re-frisk.inlined-deps.reagent.v1v2v0.reagent.core
  (:require [re-frisk.inlined-deps.reagent.v1v2v0.reagent.ratom :as ra]))
...
(defmacro reaction
  ...
  components or other solutions. Consider using re-frisk.inlined-deps.reagent.v1v2v0.reagent.core/track,
